...
- **Für Nutzer, die [das Mindestalter zur Verwaltung eines eigenen
  ...
  - Wir haben diese E‑Mail an deine Eltern oder Erziehungsberechtigten
    geschickt. Sie können die Änderungen genauer mit dir durchgehen und dir die
    Stellen erklären, die vielleicht noch unklar sind.
  - Bitte besprich diese E‑Mail mit deinen Eltern oder Erziehungsberechtigten,
    um zu entscheiden, ob du vielleicht Änderungen an deinem Konto vornehmen
    musst.
- **Wenn Sie ein Elternteil oder Erziehungsberechtigter sind und Ihr Kind die
  Dienste nutzen lassen, gilt Folgendes**:
  
  - Bitte lesen Sie die Änderungen an den Nutzungsbedingungen gemeinsam mit
    Ihrem Kind durch und helfen Sie ihm bei der Entscheidung, ob Änderungen an
...
- **Für alle anderen Nutzer unserer
  ...
  - Bitten lesen Sie diese E‑Mail, um sich über unsere aktualisierten
    Nutzungsbedingungen zu informieren und zu erfahren, welche Möglichkeiten Sie
    in Bezug auf weitere Schritte haben.
  - Wenn Sie den neuen Nutzungsbedingungen zustimmen, müssen Sie nichts weiter
    tun.
